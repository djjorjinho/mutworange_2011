<div style="font-family: Arial,  Verdana, Helvetica, sans-serif;font-size:12px;border:solid 2px #b7ddf2;background:#ebf4fb;width:850px;margin-left: 20%;">
    ...
    <form id="form1" action="" method="post" enctype="multipart/form-data" >
        ...
        <div style="width:425px;position: relative;float: left;">
            ...
            <div ><span style="display: block;position:absolute;width: 120px;text-align: right;">First Name :</span><span style="padding-left: 150px;font-size:small;font-size: 15px;">{$stFirstName|htmlentities}</span></div>
        ...
        <div style="width:425px;position: relative;float: right;">
            ...
            <div ><span style="display: block;position:absolute;width: 120px;text-align: right;">Matriculation Date :</span><span style="padding-left: 150px;font-size:small;font-size: 15px;">{$stMatrDate}</span></div>
            <div ><span style="display: block;position:absolute;width: 120px;text-align: right;">Matriculation Number :</span><span style="padding-left: 150px;font-size:small;font-size: 15px;">{$stMatrNum}</span></div>
