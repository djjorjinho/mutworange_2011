...
class PrecandidateController extends PlonkController {
    ...
    private function MainTplAssigns() {
        ...
        $this->mainTpl->assign('breadcrumb', '<a href="index.php?module=home&amp;view=userhome" title="Home">Home</a><a href="index.php?module=precandidate&amp;view=precandidate&amp;form='.$this->formid.'" title="Precandidate">Precandidate</a>');
    }
