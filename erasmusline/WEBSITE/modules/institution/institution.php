        ...
        try {
            ...
            foreach ($educations as $key => $value) {
                if ($selectedID == $value['educationId']) {
                    $this->pageTpl->assignIteration('education', "<option value='" . $value['educationId'] . "' selected = 'selected'> " .
                            $value['educationName'] . '</option>');
                } else {
                    $this->pageTpl->assignIteration('education', '<option value="' . $value['educationId'] . '"> ' .
                            $value['educationName'] . '</option>');
                }
                $this->pageTpl->refillIteration('iEducations');
            }
            ...
            case 'editeducation':
                ...
                if (PlonkSession::exists('id')) {
                    if (PlonkSession::get('id') == '0') {
                        ...
                        InstitutionDB::update('educationperinstitute', $values2, $where);
                        PlonkWebsite::redirect($_SERVER['PHP_SELF'] . '?' .
                                        PlonkWebsite::$moduleKey . '=institution&' .
                                        PlonkWebsite::$viewKey . '=educations');
                    } else {
