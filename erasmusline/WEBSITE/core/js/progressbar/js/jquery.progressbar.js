	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '../www/core/js/progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'../www/core/js/progressbar/images/progressbg_red.gif',
									30: '../www/core/js/progressbar/images/progressbg_orange.gif',
									70: '../www/core/js/progressbar/images/progressbg_green.gif'
								},
