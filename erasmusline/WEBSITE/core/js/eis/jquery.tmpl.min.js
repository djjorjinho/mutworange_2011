...
e.length;g<h;g++){o=g;f=(g>0?this.clone(true):this).get();d.fn[b].apply(d(e[g]),f);c=c.concat(f)}o=0;c=this.pushStack(c,a,e.selector)}e=x;x=null;d.tmpl.complete(e);return c}});d.fn.extend({tmpl:function(a,b,e){this.html(function(c,f){return f.replace("<![CDATA[","").replace("]]\>","")});return d.tmpl(this[0],a,b,e)},tmplItem:function(){this.html(function(a,b){return b.replace("<![CDATA[","").replace("]]\>","")});return d.tmplItem(this[0])},template:function(a){this.html(function(b,e){return e.replace("<![CDATA[",
"").replace("]]\>","")});return d.template(a,this[0])},domManip:function(a,b,e){if(a[0]&&a[0].nodeType){for(var c=d.makeArray(arguments),f=a.length,g=0,h;g<f&&!(h=d.data(a[g++],"tmplItem")););if(f>1)c[0]=[d.makeArray(a)];if(h&&o)c[2]=function(j){d.tmpl.afterManip(this,j,e)};G.apply(this,c)}else G.apply(this,arguments);o=0;x||d.tmpl.complete(m);return this}});d.extend({tmpl:function(a,b,e,c){var f=!c;if(f){c=H;a=d.template[a]||d.template(null,a);u={}}else if(!a){a=c.tmpl;m[c.key]=c;c.nodes=[];c.wrapped&&
E(c,c.wrapped);return d(v(c,null,c.tmpl(d,c)))}if(!a)return[];if(typeof b==="function")b=b.call(c||{});e&&e.wrapped&&E(e,e.wrapped);b=d.isArray(b)?d.map(b,function(g){return g?s(e,c,a,g):null}):[s(e,c,a,b)];return f?d(v(c,null,b)):b},tmplItem:function(a){var b;if(a instanceof d)a=a[0];for(;a&&a.nodeType===1&&!(b=d.data(a,"tmplItem"))&&(a=a.parentNode););return b||H},template:function(a,b){if(b){if(typeof b==="string")b=D(b);else if(b instanceof d)b=b[0]||{};if(b.nodeType)b=d.data(b,"tmpl")||d.data(b,
"tmpl",D(b.innerHTML));return typeof a==="string"?d.template[a]=b:b}return a?typeof a!=="string"?d.template(null,a):d.template[a]||d.template(null,F.test(a)?a:d(a)):null},encode:function(a){return(""+a).split("<").join("&lt;").split(">").join("&gt;").split('"').join("&#34;").split("'").join("&#39;")}});d.extend(d.tmpl,{tag:{tmpl:{_default:{$2:"null"},open:"if($notnull_1){_=_.concat($item.nest($1,$2));}"},wrap:{_default:{$2:"null"},open:"$item.calls(_,$1,$2);_=[];",close:"call=$item.calls();_=call._.concat($item.wrap(call,_));"},
each:{_default:{$2:"$index, $value"},open:"if($notnull_1){$.each($1a,function($2){with(this){",close:"}});}"},"if":{open:"if(($notnull_1) && $1a){",close:"}"},"else":{_default:{$1:"true"},open:"}else if(($notnull_1) && $1a){"},html:{open:"if($notnull_1){_.push($1a);}"},"=":{_default:{$1:"$data"},open:"if($notnull_1){_.push($.encode($1a));}"},"!":{open:""}},complete:function(){m={}},afterManip:function(a,b,e){var c=b.nodeType===11?d.makeArray(b.childNodes):b.nodeType===1?[b]:[];e.call(a,b);C(c);o++}})})(jQuery);
