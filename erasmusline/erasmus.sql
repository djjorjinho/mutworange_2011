...
--
-- Machine: localhost
-- Genereertijd: 22 Mar 2011 om 17:31
-- Serverversie: 5.1.53
-- PHP-Versie: 5.3.4
...
('0', '...', 'Asia', '', 0.00, NULL, 0, NULL, NULL, NULL, '', '', NULL, NULL, ''),
...
('AGO', 'Angola', 'Africa', 'Central Africa', 1246700.00, 1975, 12878000, 38.3, 6648.00, 7984.00, 'Angola', 'Republic', 'Jose Eduardo dos Santos', 56, 'AO'),
...
--
-- Tabelstructuur voor tabel `erasmusinfoperstudent`
--

CREATE TABLE IF NOT EXISTS `erasmusinfoperstudent` (
  `idErasmusInfo` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ErProgPerStud_idErasmusInfoPerStud` int(11) NOT NULL,
  ...
  KEY `fk_ErasmusInfoPerStudent_ErasmusProgressPerStudent1` (`ErProgPerStud_idErasmusInfoPerStud`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Gegevens worden uitgevoerd voor tabel `erasmusinfoperstudent`
--
...
--
-- Tabelstructuur voor tabel `erasmusprogressperstudent`
--

CREATE TABLE IF NOT EXISTS `erasmusprogressperstudent` (
  `id_ErasmusInfoPerStud` int(11) NOT NULL AUTO_INCREMENT,
  `date_stage 1` date DEFAULT NULL,
  `date_stage 2` date DEFAULT NULL,
  `date_stage 3` date DEFAULT NULL,
  `date_stage 4` date DEFAULT NULL,
  `date_stage ...` date DEFAULT NULL,
  `status` enum('Approved','Pending','Disapproved') NOT NULL,
  `Motivation` text,
  `ErasmusLevel_idStatusLevel` int(11) NOT NULL,
  PRIMARY KEY (`id_ErasmusInfoPerStud`),
  KEY `fk_ErasmusProgress_ErasmusLevel1` (`ErasmusLevel_idStatusLevel`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Gegevens worden uitgevoerd voor tabel `erasmusprogressperstudent`
--
...
CREATE TABLE IF NOT EXISTS `grades` (
  ...
  `ErasmusInfo_idErasmusInfo` int(11) NOT NULL,
  ...
  KEY `fk_ErasmusInfo_has_Institutions_has_Study_has_Courses_Erasmus1` (`ErasmusInfo_idErasmusInfo`),
...
CREATE TABLE IF NOT EXISTS `institutions` (
  ...
  `Name` varchar(45) DEFAULT NULL,
  `Street + Nr` varchar(45) DEFAULT NULL,
  ...
  KEY `fk_Institutions_Country1` (`Country_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Tabelstructuur voor tabel `institutions_has_study`
--

CREATE TABLE IF NOT EXISTS `institutions_has_study` (
  `Institutions_idInstitutions` int(11) NOT NULL,
  `Study_idStudy` int(11) NOT NULL,
  `Description` text,
  PRIMARY KEY (`Institutions_idInstitutions`,`Study_idStudy`),
  KEY `fk_Institutions_has_Study_Study1` (`Study_idStudy`),
  KEY `fk_Institutions_has_Study_Institutions1` (`Institutions_idInstitutions`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Gegevens worden uitgevoerd voor tabel `institutions_has_study`
--
...
--
-- Tabelstructuur voor tabel `institutions_has_study_has_courses`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `institutions_has_study_has_courses`
--
...
--
-- Tabelstructuur voor tabel `lodging`
--

CREATE TABLE IF NOT EXISTS `lodging` (
  `idLodging` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Residents_idResidents` int(11) NOT NULL,
  PRIMARY KEY (`idLodging`),
  KEY `fk_Lodging_Residents1` (`Residents_idResidents`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Gegevens worden uitgevoerd voor tabel `lodging`
--
...
--
-- Tabelstructuur voor tabel `residents`
--

CREATE TABLE IF NOT EXISTS `residents` (
  `idResidents` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Water/Electricity` tinyint(1) DEFAULT NULL,
  ...
  KEY `fk_Residents_Owner1` (`Owner_idOwner`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Gegevens worden uitgevoerd voor tabel `residents`
--
...
INSERT INTO `userlevel` (`idUserlevel`, `Name`, `Description`) VALUES
(1, '...', 'testing'),
(2, 'student', 'testing'),
(3, 'Teaching staff', 'test');
...
INSERT INTO `users` (`idUsers`, `FamilyName`, `FirstName`, `Password`, `BirthDate`, `BirthPlace`, `Sex`, `TEL`, `GSM`, `Email`, `Street`, `City`, `PostalCode`, `idUserlevel`, `idLodging`, `Code`, `isValidUser`, `verificationCode`) VALUES
(1, 'Polet', 'Bob', 'roooot', '1989-01-24', 'Ghent', 1, '2522751', '0473/430801', 'admin', 'Grote Elsdries 9', 'Melle', '9090', 2, NULL, 'BDI', NULL, 'ThvIXULBrJtH8pQDcnm74t0yJHKw7Fqc'),
(2, 'Van Assche', 'Nathan', 'roooot', '1989-01-24', 'Ghent', 0, '2522751', '0473/430801', 'nathan.vanassche@kahosl.be', 'Grote Elsdries 9', 'Melle', '9090', 3, NULL, 'BDI', 1, 'HTtqtbQo7ufmmDkWngaoNMhX5ansszDB'),
(3, 'Moens', 'Jonas', 'roooot', '1989-01-24', 'Ghent', 1, '2522751', '0473/430801', 'nathan.vanassche@kahosl.be', 'Grote Elsdries 9', 'Melle', '9090', 3, NULL, 'AZE', 1, 'M2uuYkrRxJHMbC0VGyxFcyjy3ATszroy');
...
--
-- Beperkingen voor tabel `erasmusinfoperstudent`
--
ALTER TABLE `erasmusinfoperstudent`
  ADD CONSTRAINT `fk_ErasmusInfoPerStudent_ErasmusProgressPerStudent1` FOREIGN KEY (`ErProgPerStud_idErasmusInfoPerStud`) REFERENCES `erasmusprogressperstudent` (`id_ErasmusInfoPerStud`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ErasmusInfo_Institutions1` FOREIGN KEY (`idHomeInstitution`) REFERENCES `institutions` (`idInstitutions`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ErasmusInfo_Institutions2` FOREIGN KEY (`idHostInstitution`) REFERENCES `institutions` (`idInstitutions`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ErasmusInfo_Users1` FOREIGN KEY (`idHomeCoordinator`) REFERENCES `users` (`idUsers`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ErasmusInfo_Users2` FOREIGN KEY (`idStudent`) REFERENCES `users` (`idUsers`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ErasmusInfo_Users3` FOREIGN KEY (`idHostCoordinator`) REFERENCES `users` (`idUsers`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `erasmusprogressperstudent`
--
ALTER TABLE `erasmusprogressperstudent`
  ADD CONSTRAINT `fk_ErasmusProgress_ErasmusLevel1` FOREIGN KEY (`ErasmusLevel_idStatusLevel`) REFERENCES `erasmuslevel` (`idStatusLevel`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `grades`
--
ALTER TABLE `grades`
  ADD CONSTRAINT `fk_ErasmusInfo_has_Institutions_has_Study_has_Courses_Erasmus1` FOREIGN KEY (`ErasmusInfo_idErasmusInfo`) REFERENCES `erasmusinfoperstudent` (`idErasmusInfo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Grades_Institutions_has_Study_has_Courses1` FOREIGN KEY (`Institutions_has_Study_has_Courses_id`) REFERENCES `institutions_has_study_has_courses` (`spec_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `institutions`
--
ALTER TABLE `institutions`
  ADD CONSTRAINT `fk_Institutions_Country1` FOREIGN KEY (`Country_Code`) REFERENCES `country` (`Code`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `institutions_has_study`
--
ALTER TABLE `institutions_has_study`
  ADD CONSTRAINT `fk_Institutions_has_Study_Institutions1` FOREIGN KEY (`Institutions_idInstitutions`) REFERENCES `institutions` (`idInstitutions`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Institutions_has_Study_Study1` FOREIGN KEY (`Study_idStudy`) REFERENCES `study` (`idStudy`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `institutions_has_study_has_courses`
--
ALTER TABLE `institutions_has_study_has_courses`
  ADD CONSTRAINT `fk_Institutions_has_Study_has_Courses_Courses1` FOREIGN KEY (`idCourses`) REFERENCES `courses` (`idCourses`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Institutions_has_Study_has_Courses_Institutions_has_Study1` FOREIGN KEY (`idInstitutions`, `idStudy`) REFERENCES `institutions_has_study` (`Institutions_idInstitutions`, `Study_idStudy`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `lodging`
--
ALTER TABLE `lodging`
  ADD CONSTRAINT `fk_Lodging_Residents1` FOREIGN KEY (`Residents_idResidents`) REFERENCES `residents` (`idResidents`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `residents`
--
ALTER TABLE `residents`
  ADD CONSTRAINT `fk_Residents_Owner1` FOREIGN KEY (`Owner_idOwner`) REFERENCES `owner` (`idOwner`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Beperkingen voor tabel `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_Users_Country1` FOREIGN KEY (`Code`) REFERENCES `country` (`Code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Users_Lodging1` FOREIGN KEY (`idLodging`) REFERENCES `lodging` (`idLodging`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Users_Userlevel1` FOREIGN KEY (`idUserlevel`) REFERENCES `userlevel` (`idUserlevel`) ON DELETE NO ACTION ON UPDATE NO ACTION;
